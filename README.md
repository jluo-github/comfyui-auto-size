...
|-------|----------|---------------------|--------|
| **Qwen-Image** | Text-to-image | 28px | [Official docs](https://qwen.ai/) |
| **Z-Image** | Text-to-image | 32px | [Official docs](https://z.ai/) |
| **Flux2-Klein** | Text-to-image | 32px | Similar to Z-Image/Illustrious |
